...
import DatasetsList from "@/app/my-datasets/datasets-list";
...
export default async function MyDatasets() {
  ...
  const datasetsWithDeleteFlag = datasets.map((dataset) => ({
    ...dataset,
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="border-b border-black dark:border-white pb-4 mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            View and manage your OpenStreetMap datasets across different cities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="border border-black dark:border-white p-6 lg:col-span-2">
            ...
            <DatasetsList datasets={datasetsWithDeleteFlag} />
          </div>
        </div>
      </div>
    </div>
